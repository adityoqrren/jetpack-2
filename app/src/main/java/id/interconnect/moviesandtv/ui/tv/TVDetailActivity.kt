...
//    private var idDetailTV: Int = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvViewModel = ViewModelProvider(this,ViewModelFactory.getInstance(this))[TVViewModel::class.java]
...
//            idDetailTV = intent.getIntExtra(KEY_TV_ID, 0)
//        }
        if (intent.hasExtra(KEY_TV_ID)) {
            val tvId = intent.getIntExtra(KEY_TV_ID, 0)
            if(tvId != 0) {
                Log.d("debug tvDetailActivity","id: "+tvId.toString())
...
//            Log.d("test click", idDetailTV.toString())
//            if(idDetailTV!=0){
